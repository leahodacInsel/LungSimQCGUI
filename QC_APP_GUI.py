...
class IntroWindow(tk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.previous_session_label = ttk.Label(self,
                                                ...
                                                background=color_intro_window, font=(main_font, font_medium),
        ...
        self.previous_session_label.grid(row=4, column=0, columnspan=2)
        self.previous_session_button.grid(row=4, column=2)
